...
public class JDialogUserAUD extends javax.swing.JDialog {
    ...
    public JDialogUserAUD(com.vrs.gui.JFrameVRS parent, boolean modal, String evtl, User user) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    public JDialogUserAUD(com.vrs.gui.JFrameVRS parent, boolean modal, User user, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
