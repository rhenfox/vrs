...
public class JDialogTypeAU extends javax.swing.JDialog {
    ...
    private com.vrs.model.Type type = new com.vrs.model.Type();
     ...
     * @param modal
     */
    public JDialogTypeAU(com.vrs.gui.JFrameVRS parent, boolean modal) {
        super(parent, modal);
        this.jframeVR = parent;
        initComponents();
    }

    public JDialogTypeAU(com.vrs.gui.JFrameVRS parent, boolean modal, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        setTitle("Add Type");
    ...
    public JDialogTypeAU(com.vrs.gui.JFrameVRS parent, boolean modal, String evtl, com.vrs.model.Type type) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        this.type = type;
        ...
        jTextFieldType.setText(this.type.getType());
        jTextAreaDescription.setText(this.type.getDescription());

    }

    public JDialogTypeAU(com.vrs.gui.JFrameVRS parent, boolean modal, com.vrs.model.Type type, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        this.type = type;
    ...
    private void initComponents() {
        ...
        jTextFieldType.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N
        jPanel2.add(jTextFieldType, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 35, 260, -1));

        jTextAreaDescription.setColumns(20);
        jTextAreaDescription.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N
        ...
        setSize(new java.awt.Dimension(292, 284));
            ...
            switch (this.evt) {
                case "Add" -> {
                    int reply = JOptionPane.showConfirmDialog(this,
                            "Are you sure  to save " + jTextFieldType.getText() + "   " + jTextAreaDescription.getText() + " ?",
                            "Confirmation - Exit", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
                    if (reply == JOptionPane.YES_OPTION) {
                        type.setType(jTextFieldType.getText());
                        type.setDescription(jTextAreaDescription.getText());
                        new AppQuery().addType(type);
