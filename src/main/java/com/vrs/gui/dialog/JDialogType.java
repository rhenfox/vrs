 ...
 * @author Aldrin
 */
public class JDialogType extends javax.swing.JDialog implements MouseListener {

    private com.vrs.gui.JFrameVRS mainMenu;
    ...
    public JDialogType(com.vrs.gui.JFrameVRS parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(691, 426));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogTypeAU u = new JDialogTypeAU(mainMenu, true, "Add");
        u.setTitle("Add Type");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogTypeAU u = new JDialogTypeAU(mainMenu, true, "Update", this.type);
        u.setTitle("Update Type");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        selectTypes();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogTypeAU u = new JDialogTypeAU(mainMenu, true, this.type, "Delete");
    ...
    private ArrayList<com.vrs.model.Type> typeList;
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object typel = jTable1.getValueAt(row, 1);
                        Object descriptionl = jTable1.getValueAt(row, 2);
                        type.setId(Integer.parseInt(idl.toString()));
                        type.setType(typel.toString());
                        type.setDescription(descriptionl.toString());
    ...
    private void selectTypes() {
        typeList = query.getTypeList();
        tableModel.setRowCount(0);
        for (com.vrs.model.Type c : typeList) {
            tableModel.addRow(new Object[]{c.getId(),  c.getType(), c.getDescription()});
        }
    }
}
